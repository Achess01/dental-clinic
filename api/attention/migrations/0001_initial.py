    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('modified', models.DateTimeField(auto_now=True, verbose_name='modified at')),
                ('rut', models.CharField(error_messages={'unique': 'Patient rut must be unique'}, max_length=13, unique=True, validators=[django.core.validators.RegexValidator(message='Rut must be atleast 9 characters and up to 13 characters. Only letters and digits allowed', regex='[a-zA-Z0-9]{9,13}$')])),
                ...
                ('occupation', models.CharField(help_text='What is the occupation of the patient', max_length=255, verbose_name='patient occupation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voucher_state', models.CharField(blank=True, choices=[('PAID', 'PAID'), ('PENDING', 'PENDING')], max_length=10)),
                ('surface', models.CharField(blank=True, choices=[('M', 'M'), ('O', 'O'), ('D', 'D')], max_length=1)),
                ('appointment', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='attention.appointment')),
        ...
        migrations.AddField(
            ...
            name='patient',
            field=models.ForeignKey(help_text='Patient who is asking for an appointment', on_delete=django.db.models.deletion.CASCADE, to='attention.patient'),
        ),
        migrations.AddField(
            model_name='appointment',
            name='secretary',
            field=models.ForeignKey(help_text='Secretary who is setting the appointment', null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.secretary'),
        ),
        migrations.AddField(
            model_name='appointment',
            name='specialist',
            field=models.ForeignKey(help_text='Specialist who attends the patient', on_delete=django.db.models.deletion.CASCADE, to='users.specialist'),
        ),
    ]
