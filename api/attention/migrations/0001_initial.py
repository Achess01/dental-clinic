    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('modified', models.DateTimeField(auto_now=True, verbose_name='modified at')),
                ('rut', models.CharField(max_length=13, primary_key=True, serialize=False, validators=[django.core.validators.RegexValidator(message='Rut must be atleast 9 characters and up to 13 characters.', regex='\\w{9,13}$')])),
                ...
                ('medical_history', models.CharField(help_text='It describes what some important medical history of the patient', max_length=255, verbose_name='patient medical history')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('treatment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='attention.treatment')),
                ('tretment_performed', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='attention.treatmentperformed')),
            ],
            options={
                'ordering': ['-created', '-modified'],
                'get_latest_by': 'created',
